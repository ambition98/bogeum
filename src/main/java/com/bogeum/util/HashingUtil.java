...
public class HashingUtil {
	...
	private static final int KEY_STRETCHING_CNT = 10000;
	private static final String HASH_ALGORITHM = "SHA-256";
			
	public static String makeNewSalt() {
	 ...
	 */
	public static String hashing(String pwd, String salt) throws NoSuchAlgorithmException {
